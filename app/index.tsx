...
export default function LoadingScreen() {
  ...
  return (
    <Animated.View style={[styles.root, { backgroundColor: rootBg as any }, Platform.OS === 'web' && styles.rootWeb]}>
      <Animated.View
        style={[
          styles.centerStage,
      ...
      >
        ...
        >
          <Text style={styles.brandName}>
            BOOLOK <Text style={{ color: GOLD }}>AI</Text>
          </Text>
...
const styles = StyleSheet.create({
  ...
  valuesBar: {
    ...
    flexWrap: 'wrap',
    gap: 0,
    // Soft top border instead of hard box edge
    borderTopWidth: 0,
